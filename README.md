...
```bash
git clone https://github.com/komailo/ansible-collection-mac-dev.git
...
- **Issues**: [GitHub Issues](https://github.com/komailo/ansible-collection-mac-dev/issues)
- **Documentation**: [Project Wiki](https://github.com/komailo/ansible-collection-mac-dev/wiki)
- **Discussions**: [GitHub Discussions](https://github.com/komailo/ansible-collection-mac-dev/discussions)
